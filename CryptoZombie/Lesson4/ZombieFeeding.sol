...
contract ZombieFeeding is ZombieFactory {
  ...
  // Modifier permettant de vérifier qu'un zombie appartient bien à l'appelant. 
  ...
  // On utilise le modifier ownerOf pour s'assurer que l'appelant est proprietaire du zombie. 
